        ...
        <CardContent>
          <form onSubmit={handleChangePassword} className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="settings-orphan-current-password">
                Current password <span className="text-destructive">*</span>
              </Label>
              <Input
                id="settings-orphan-current-password"
                type="password"
            ...
            <div className="flex flex-col gap-1.5 sm:col-start-1">
              <Label htmlFor="settings-orphan-new-password">
                New password <span className="text-destructive">*</span>
              </Label>
              <Input
                id="settings-orphan-new-password"
                type="password"
                value={newPassword}
            ...
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="settings-orphan-confirm-password">
                Confirm new password <span className="text-destructive">*</span>
              </Label>
              <Input
                id="settings-orphan-confirm-password"
                type="password"
