...
export function Modal({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-end justify-center p-3 md:items-center"
      style={{ background: "var(--overlay-scrim)" }}
      role="dialog"
      aria-modal="true"
    >
      <div
        className="w-full max-w-2xl overflow-hidden rounded-lg border border-[var(--aw-border-soft)] bg-[var(--aw-surface)]"
