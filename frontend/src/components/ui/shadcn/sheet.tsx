...
const sheetVariants = cva(
  "fixed z-modal gap-4 bg-card text-card-foreground shadow-xl transition ease-standard data-[state=closed]:duration-base data-[state=open]:duration-base data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
